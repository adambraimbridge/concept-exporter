...
func (handler *RequestHandler) getCandidateConceptTypes(request *http.Request, tid string) (candidates []string, err error) {
	candidates = extractCandidateConceptTypesFromRequest(request, handler.Log)
...
func extractCandidateConceptTypesFromRequest(request *http.Request, log *logger.UPPLogger) (candidates []string) {
